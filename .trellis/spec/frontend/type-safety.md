...
### Generator Upgrade Boundary

- Treat `@hey-api/openapi-ts` version upgrades as generated-contract
  migrations, not routine lockfile refreshes.
- Preserve the current generated client before testing an upgrade. If the
  existing plugin configuration generates no files or deletes the output,
  restore the client and defer the upgrade until plugin mapping and export
  compatibility are reviewed.
- Keep a deliberate Dependabot ignore for a deferred generator migration so
  an unattended update cannot erase the generated client.
...
- Generated-client usage: [`frontend/src/platform/auth/hooks/useAuth.ts`](../../../frontend/src/platform/auth/hooks/useAuth.ts), [`frontend/src/platform/auth/pages/LoginPage.tsx`](../../../frontend/src/platform/auth/pages/LoginPage.tsx)
