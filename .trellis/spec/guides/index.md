...
- Technical plan or spec reviews should start from `.trellis/spec/**` and relevant current docs when durable repository knowledge matters, then verify the claim against current code before accepting it.
...
- For repository-aware reviews or architecture questions: check `.trellis/spec/**` and relevant current docs before final judgment.
