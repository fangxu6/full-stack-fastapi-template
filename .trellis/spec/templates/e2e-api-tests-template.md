...
- Isolation: identify the test database, Compose profile, or other isolated
  environment; do not write test fixtures to a development database.
...
- Start or verify the local stack with Docker Compose when it is the selected
  environment.
