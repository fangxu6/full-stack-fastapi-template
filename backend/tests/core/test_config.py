...
def test_inventory_daily_report_recipients_parse_from_json() -> None:
...
def test_inventory_daily_report_recipients_reject_invalid_mappings(
    recipients: str,
) -> None:
    with pytest.raises(ValidationError):
        make_settings(INVENTORY_DAILY_REPORT_RECIPIENTS=recipients)
