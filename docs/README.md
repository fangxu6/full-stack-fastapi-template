...
- `docs/ai-inventory-fastapi-sidecar-operation-guide.md`：库存 AI 的非 Docker FastAPI、sidecar、迁移、provider 兼容性和故障排查指南。
- `docs/ai-inventory-yaak-guide.md`：使用 Yaak 登录、调用库存 AI BFF、读取响应和关联 request ID 的指南。
