...
If you need the full wire format, see [Schemas](https://developers.openai.com/codex/#schemas).
...
Fields in addition to [Common input fields](https://developers.openai.com/codex/#common-input-fields):
...
JSON on `stdout` supports [Common output fields](https://developers.openai.com/codex/#common-output-fields) and this hook-specific shape:
...
JSON on `stdout` supports [Common output fields](https://developers.openai.com/codex/#common-output-fields). If a matching `PreCompact` hook returns `continue: false`, Codex stops before compacting.
...
JSON on `stdout` supports [Common output fields](https://developers.openai.com/codex/#common-output-fields). If a matching `PostCompact` hook returns `continue: false`, Codex stops after compacting.
...
JSON on `stdout` supports [Common output fields](https://developers.openai.com/codex/#common-output-fields). To ask Codex to continue the subagent flow, return:
...
JSON on `stdout` supports [Common output fields](https://developers.openai.com/codex/#common-output-fields). To keep Codex going, return:
