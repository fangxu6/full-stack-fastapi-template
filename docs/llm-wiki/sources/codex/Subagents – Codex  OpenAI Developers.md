...
You can also override the sandbox configuration for individual [custom agents](https://developers.openai.com/codex/#custom-agents), such as explicitly marking one to work in read-only mode.
