...
# 获取配置文件变更
git diff origin/master...HEAD -- '*.yml''*.yaml''*.properties''*.json''*.env'
**分析重点**：
...
读取文档维护规范：
**todo 更新文档地址** 
- `docs/私域知识工程体系产出/知识沉淀/数据模型手册.md` - "文档维护规范"章节
- `docs/私域知识工程体系产出/知识沉淀/专业术语词汇表.md` - "文档维护规范"章节
- `docs/私域知识工程体系产出/知识沉淀/业务逻辑手册.md` - "文档维护规范"章节
- `docs/私域知识工程体系产出/知识沉淀/开发规范与最佳实践.md` - "文档维护规范"章节
- `docs/私域知识工程体系产出/系统架构分析.md` - "文档维护规范"章节
