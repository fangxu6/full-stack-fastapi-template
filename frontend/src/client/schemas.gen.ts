...
export const Body_inventory_import_documents_from_excelSchema = {
    properties: {
        workbook: {
            type: 'string',
    ...
    type: 'object',
    required: ['workbook'],
    title: 'Body_inventory-import_documents_from_excel'
} as const;

export const Body_inventory_import_legacy_workbooks_from_excelSchema = {
    properties: {
        raw_workbook: {
            type: 'string',
            contentMediaType: 'application/octet-stream',
        ...
        finished_workbook: {
            type: 'string',
            contentMediaType: 'application/octet-stream',
            title: 'Finished Workbook'
        }
    },
    type: 'object',
    required: ['raw_workbook', 'finished_workbook'],
    title: 'Body_inventory-import_legacy_workbooks_from_excel'
} as const;
...
export const InventoryExcelImportPublicSchema = {
    properties: {
        created_documents: {
            type: 'integer',
    ...
    type: 'object',
    required: ['created_documents', 'document_numbers'],
    title: 'InventoryExcelImportPublic'
} as const;
...
export const LegacyInventoryExcelImportPublicSchema = {
    properties: {
        import_batch_id: {
            type: 'string',
            format: 'uuid',
    ...
    type: 'object',
    required: ['import_batch_id', 'report'],
    title: 'LegacyInventoryExcelImportPublic'
} as const;
