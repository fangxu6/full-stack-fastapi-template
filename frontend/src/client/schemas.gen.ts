...
export const AiInventoryCitationSchema = {
    properties: {
        source: {
            type: 'string',
            title: 'Source'
    ...
    title: 'AiInventoryCitation'
} as const;

export const AiInventoryQueryRequestSchema = {
    properties: {
        question: {
            type: 'string',
            maxLength: 1000,
    ...
    type: 'object',
    required: ['question'],
    title: 'AiInventoryQueryRequest'
} as const;

export const AiInventoryQueryResponseSchema = {
    properties: {
        run_id: {
            type: 'string',
            format: 'uuid',
        ...
        citations: {
            items: {
                '$ref': '#/components/schemas/AiInventoryCitation'
            },
            type: 'array',
            title: 'Citations'
        }
    ...
    type: 'object',
    required: ['run_id', 'answer', 'citations'],
    title: 'AiInventoryQueryResponse'
} as const;
