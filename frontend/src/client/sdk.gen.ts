...
export class SchedulerService {
     ...
     * Preview Cron
     * @param data The data for the request.
     * @param data.cronExpression
     * @returns SchedulerCronPreviewPublic Successful Response
     * @throws ApiError
     */
    public static previewCron(data: SchedulerPreviewCronData): CancelablePromise<SchedulerPreviewCronResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/scheduler/cron-preview',
            query: {
