...
export type Body_inventory_import_documents_from_excel = {
    workbook: string;
};

export type Body_inventory_import_legacy_workbooks_from_excel = {
    raw_workbook: string;
    finished_workbook: string;
};
...
export type InventoryExcelImportPublic = {
    created_documents: number;
    document_numbers: Array<(string)>;
};
...
export type LegacyInventoryExcelImportPublic = {
...
export type InventoryImportDocumentsFromExcelResponse = (InventoryExcelImportPublic);

export type InventoryImportLegacyWorkbooksFromExcelData = {
    formData: Body_inventory_import_legacy_workbooks_from_excel;
};

export type InventoryImportLegacyWorkbooksFromExcelResponse = (LegacyInventoryExcelImportPublic);
