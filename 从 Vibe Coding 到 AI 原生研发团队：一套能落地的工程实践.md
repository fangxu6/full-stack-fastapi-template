...
source: "https://mp.weixin.qq.com/s/DrIpzHm777Zd8klcyAICBA"
author:
  - "[[腾讯程序员]]"
published:
created: 2026-07-22
description: "AI 写个人玩具项目很顺手，但落到真实业务里就是另一回事了。"
tags:
  - "clippings"
---
原创 腾讯程序员 *2026年7月21日 18:03*
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9adz905pfbWKTVkecyaLHN15WiayOVkAyKA0uBZrSAibcakVSryUMQs9yQibxJp6cmoIonjkOp8MONnjGmuhKkKRSXCuYHy4f6BnworpR0/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=2)
...
每个人写的 网页都在各自调用后端系统接口：运营的、网管的、CMDB 的、SNMP 的，各写各的，互不知道。同样是查一条专线的信息，张三的页面查一遍，李四的页面又查一遍 ，鉴权方式、数据口径还不一样。更麻烦的是数据散落在各个孤岛里，没法关联分析。比如专线流量异常了，想同时看流量趋势、丢包率、运营商质量，得开三四个页面来回切，数据还对不上。
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz904wUdm8eNEziaQu2SicTNkrCKm770B4RoDFLgC0DaVTy1Q8qXSjxGtGgRzyUyhGf0NOd2mYzTVI5yQ995xkXFrA4Ge6QvPFdict4E/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=3)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9adz907cYkiceViaj2GxeofAcNeDKM4IshzU4ibFpA38xIia7k2advCz8ibLm7Hb0LcCNESg71ss3kD8xribG2OWoaQwD5QULA8Uiar9Cbntnw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=4)

这套 AI 原生的开发体系已经在海外网络运营、控制器运营团队应，团队基于统一的 AI 研发基础设施，能够在 3 分钟内全自动完成环境配置，人人可以参与开发。

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz906DozKFiaNucPNMV8tr1p1a1zWE8uhVz6W0IiaEicQAPNRH6rMUDmZSGxiakrSZnjQcRpZM4pKteegzBnBmgdxNFN3ib2uBKkZ2cCU0/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=5)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz904f2FkzPuoCA5Sra7m0QD15kGvOeNok8lCiaAiajl6KG5uG0Ds9wAhSj9wibrUYe7s7tWKwL0TKibLGVcO7rcOd8IAqAttEibbnLJSc/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=6)

2、AI 编码实现并进行自主测试迭代

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz905o05eBCsHTiaCqpGr3Gpw5nZqZsc8BIM8uzIn8mrPiapYaXOrrv8Cq8a5H5yibkQwJ5AMSibZOPtke1psLw3GI46pMK7s4SBT3s4o/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=7)

3、Agnt 对话效果：

![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz906k3KACBYY8RX6y3UMgGD9S2UnVNic0J1nmBDJjDR0tOo9POxruNVnTG4rct5ym1ggtbU5vcORllyI2ZlxeJB1pAjnuQ0ovHH48/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=8)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz906EoZrIVSeaxPsmVicIq9lb8W8W9f85ywwz7cgaR9Z1YgBdOwMDeIuhciaOFI7Pgvqxyzt5t3AWxd0GfBCHy2icy1OP6LjficGqDTw/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=9)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9adz90625wdOibkre2qPrlrxZCyyrL6lTR4dnY5ZU0um0j2TicHJj6W6kxhwIlhf4SvEp9REiaicQL9LCIgIptE4FJicajkWXEia2Wgs0n8LE/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=10)
...
**页面权限控制** ：我们实现了 RBAC 权限模型。用户的身份信息由太湖网关注入，后端解码后拿到 login\_name，再从人事系统查到部门和组。权限规则存在数据库里，支持按页面和操作两个粒度控制，管理员列表走七彩石远程配置，方便动态调整。这套机制对 AI 透明，AI 写新页面时，只需要声明是否受限资源，权限校验自动生效。
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9ad
640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=23)
...
**第六步：安装项目依赖** 。后端 `uv sync` 、前端 `pnpm install` ，一条命令搞定。前端安装时一次性放行 `onlyBuiltDependencies` 的构建脚本，避免后续启动时因 ERR\_PNPM\_IGNORED\_BUILDS 退出。
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz9073k2WqOalAEC6vUh4iaJKXAcUXTSJ7tASicY12GMkfIibAhlKLpicZV3bdDEkUhDEueYeHWF4x5gRmsf5tiay253wXnxEszeiaCrNI8/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=24)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9adz906HtrfSB1rmjichKL6VSjeoswq3w5youP0ibwC5m94OaJg1WPU29VYibkJVHfUuPY41Za9YY5wgKNOmV3dGK1YibFsoOOCjiaODic35s/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=25)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9adz904GV5rqmyiaYPIKqYQ9Tzreia0MfLIwTFXEo4Uvpn8wFmZIhImQGhRRC0mnoH6OBiacOzwTnssI4AT2K5fbCXY5ib5CUtpqO9QiameE/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=26)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz905XKkia7V9kSD4dQTWtgeqAgia23AZyVtCADGftT2YdL1iaGiakxBL9YJmhAwgDW5wEZa05rWrESzwIgodtTNoNaUco9LcDgs0QdhM/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=27)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9adz906JYgaRzjdWZFe5WL2k8aOjwKR8P6uUicm8WFo3Kw7KsUWQN8AcrtWIkEwM5l0AAicyTANRbD4CohAria0uiaRNwFrDm0SM6RawUIs/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=28)
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_png/KVER9adz906ibpWwe1EaKPricuFqPVO6Vjqq4uRY8sGunAQuV6E8CDohZsGc8Z7K3sJWuE5B49jvia38uDibWz9ibJHV4J9uZGW4AicCmOm8t6foU/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=29)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9adz906sBcamRFNzIHW97D7jEsvETj8OkTtbxUxo6Zz2zen9d5ZvP4Cu3wricpVq6pAONJXXCo7Rpsk4dS2fIyN6AGKBgt9kIG0esJuo/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=30)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/KVER9adz904gptBu7CBVKNeO6gEoHy7SSibAKL9tcOSESwaskHiaoibsicK47m4737NuZd6YD1vlcuDLqug1GMibWQwFRzukD0u0bicUbL2BH3jjk/640?wx_fmt=png&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=31)
...
**第二层：工程护栏** 。大仓分层 + AGENTS.md 规范 + anydev\_rule 流程约束 + Memory 记忆系统，构成 Rules 三层护栏；Agent 创建、前端设计、Vue 开发、工蜂等 Skills 预装技能包。配合 CLI 工具、DB 变更管控、TDD 验收闭环、SDD 文档驱动、组件化 + Storybook，让 AI 既守规矩又高效。这一层的价值是：AI 的行为有下限保障，人的审查负担降到最低。
...
![图片](https://mmbiz.qpic.cn/sz_mmbiz_gif/j3gficicyOvasVeMDmWoZ2zyN8iaSc6XWYjZ7Hx6Udjjk2BGLzC9ahJq7ibxDd1RGA0c9NYZc1husEsvb3tY4FcWPQ/640?wx_fmt=gif&from=appmsg&tp=webp&wxfrom=5&wx_lazy=1#imgIndex=32) ![图片](https://mp.weixin.qq.com/s/www.w3.org/2000/svg'%20xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Ctitle%3E%3C/title%3E%3Cg%20stroke='none'%20stroke-width='1'%20fill='none'%20fill-rule='evenodd'%20fill-opacity='0'%3E%3Cg%20transform='translate(-249.000000,%20-126.000000)'%20fill='%23FFFFFF'%3E%3Crect%20x='249'%20y='126'%20width='1'%20height='1'%3E%3C/rect%3E%3C/g%3E%3C/g%3E%3C/svg%3E)